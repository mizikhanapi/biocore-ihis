...
<table  id="billParameterTable"  class="table table-striped table-bordered" cellspacing="0" width="100%">
    <thead>
    <th style="text-align: left;">Parameter Code</th>
...
<td align="center">
    <!-- Update Part Start -->
    <a id="billParameterUpdateTButton" data-toggle="modal" data-target="#billParameterModal"><i class="fa fa-pencil-square-o" data-toggle="tooltip" data-placement="left" title="Update Item" aria-hidden="true" style="display: inline-block;color: #337ab7;"></i></a>
    <!-- Update Part End -->
    &nbsp;&nbsp;
    <!-- Delete Button Start -->
    <a id="billParameterDeleteTButton" ><i class="fa fa-times" data-toggle="tooltip" data-placement="right" title="Delete Item" aria-hidden="true" style="display: inline-block;color: #d9534f; width: " ></i></a>
    <!-- Delete Button End -->
</td>
</tr>
<%
