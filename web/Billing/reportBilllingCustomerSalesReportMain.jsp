...
<div class="form-horizontal" >
    ...
    <div class="text-right" style="margin-bottom: 10px;width: 100%;">
        <button id="billingReportCustomerSalesReportDailySalesBtn" class="btn btn-default" >Daily Sales Report</button>
        <button id="billingReportCustomerSalesReportMonthlySalesBtn" class="btn btn-default" >Monthly Sales Report</button>
        <button id="billingReportCustomerSalesReportYearlySalesBtn" class="btn btn-default" >Yearly Sales Report</button>
    </div>
</div>
