                            ...
                            <div class="thumbnail">
                                ...
                                <div class="form-group form-horizontal">
                                    <div id="reload">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-4 control-label">Buying Price (RM)</label>
                                            <div class="col-md-4" style="margin-bottom: 10px">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-4 control-label">Selling Price (RM)</label>
                                            <div class="col-md-4" style="margin-bottom: 10px">
                                        ...
                                        <div class="text-center" style="margin-bottom: 10px">
                                            ...
                                            <button id="update" class="btn btn-primary" disabled="true">
                            ...
                            <div class = "thumbnail">
                                <form class="form-horizontal" name="myForm">
                                    <div id="custom-search-input">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <input id="search" type="text" class=" search-query form-control" placeholder="Enter Item Name to Filter" onkeyup="searchItem()"/>
                                            </div>
                                        </div>
                                    </div>
                                </form>   
