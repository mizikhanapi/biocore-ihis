...
<%
    ...
    Conn conn = new Conn();
    String sqlUpdate = "UPDATE lhr_ort_neu_observation_chart SET on_left='"+left_pupil+"', on_right='"+right_pupil+"' WHERE pmi_no = '" + pmino + "' AND hfc_cd = '"+hfc+"' AND episode_date = '"+episodeDate+"' AND encounter_date='"+encounter_date+"'";
