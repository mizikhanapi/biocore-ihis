...
<tbody id="THE_detailTable_body">

<td colspan="9"><div class="btn-group center-block" role="group" style="padding: 10px; width: 10%" >
        <button class="btn btn-info btn-block btn-md" role="button" id="DLT_showTable" style="font-size: 1vw;">View Data</button>
</div><td>
...
//                $('#THE_detailTable_body').html(data);
...
//    });
            ...
            $.ajax({
                ...
                success: function (datas) {
                    ...
                    if (datas.trim() === 'Success') {
                        $('#DLT_detail2_').modal('hide');
                        bootbox.alert("A lookup detail code is updated", function () {
    ...
    $('#DLT_showTable').on('click', function () {

        $('#THE_detailTable_body').html('<td colspan="9"><div style"margin: auto; width: 50%;border: 3px solid green;padding: 10px;" class="loader" ></div><td>');
