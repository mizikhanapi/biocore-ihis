    ...
    <div class="form-group"> 
        ...
        <div class="col-md-4">
            <select id="SCH_searchType" class="form-control" >
                ...
                <option value="3">Patient schedule</option>
<!--
    ...
    <div class="form-group searchingDiv" id="SCH_div_roomSchedule">
        ...
        <div class="col-md-3">
            <input type="text" class="form-control input-md" id="SCH_srcRoomNo" placeholder="Insert the room number to be searched." >
        </div>
    ...
    <div class="form-group searchingDiv" id="SCH_div_srcPatient" style="display: none;">
        <label class="col-md-4 control-label" for="textinput">PMI number</label>
        <div class="col-md-3">
            <input type="text" class="form-control input-md" id="SCH_srcPmiNo" placeholder="Insert the patient PMI number to be searched." >
        </div>
