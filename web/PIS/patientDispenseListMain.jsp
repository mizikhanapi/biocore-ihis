        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
                <div class="input-group">
                    <select class="form-control"  id="PIS_DispenseTime" style="margin-bottom: 0px !important;">
                    ...
                    <span class="input-group-btn">
                        <button class="btn btn-default" id="PIS_DispenseSearch"><i class=" fa fa-search" style=" padding-right: 5px;padding-left: 5px;color: black;"></i></button>
                    </span>
                </div>
            </div>
            <button class="btn btn-default" id="PIS_DispenseRefresh" style=" padding-right: 10px;padding-left: 10px;color: black;"><i class=" fa fa-refresh" style=" padding-right: 10px;padding-left: 10px;color: black;"></i>Refresh</button>
        </div>
...
<script>
    $(function () {
        ...
        $('#PIS_DispenseTime').on('change', function () {
        ...
        $('#PIS_DispenseSearch').on('click', function () {
