...
<tbody>
    ...
    <%
        ...
        String sql = " SELECT YEAR(pis_dispense_master.DISPENSED_DATE) AS DATE,COUNT(pis_dispense_detail.DRUG_ITEM_CODE), "
                ...
                + " WHERE pis_dispense_master.LOCATION_CODE  = '04010101' AND pis_dispense_master.DISCIPLINE_CODE  = '"+dis+"'  "
                + " AND pis_mdc2.hfc_cd  = '04010101' AND pis_mdc2.discipline_cd  = '"+dis+"' GROUP BY DATE; ";
                    ...
                    customize: function (win) {
                        $(win.document.body)
                                ...
                                .prepend(
                                        ...
                                        <img src="<%=mysqlhfc_cd.get(0).get(0)%>" style="text-align: center; height: 100%; " /></div> <div class="mesej">Pharmacy Yearly Dispensed Drug List</div>\n\
