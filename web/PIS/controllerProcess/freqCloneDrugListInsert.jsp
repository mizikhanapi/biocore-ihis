...
<%
    ...
    for (int i = 0; i < freqs.length; i++) {
        ...
        sqlInsert = "INSERT INTO pis_drug_frequency (frequency_code, frequency_desc, frequency_value,hfc_cd,discipline_cd,subdiscipline_cd,status) "
                + " SELECT frequency_code, frequency_desc, frequency_value, '" + hfc + "','" + dis + "', '" + sub + "',status "
