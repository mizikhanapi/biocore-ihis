...
<%
    ...
    if (DISPENSED_BY == null) {
        ...
        String sqlFetchMasterDispenseData = ""
                + " SELECT * "
        ...
        if (checkDispenseMaster.size() == 1) {
            ...
            String sqlInsertDispenseMaster = ""
                    + " UPDATE pis_dispense_master "
                    + " SET DISPENSED_BY = '" + DISPENSED_BY + "', DISPENSED_DATE = '" + DISPENSED_DATE + "' "
                    + " WHERE ORDER_NO = '" + ORDER_NO + "' ";
        ...
        String sqlFetchDetailsDispenseData = ""
                + " SELECT ORDER_NO,DRUG_ITEM_CODE "
                + " FROM pis_dispense_detail "
        ...
        if (checkDispenseDetails.size() == 0) {
            ...
            String sqlInsertDispenseDetail = ""
                    + " INSERT INTO pis_dispense_detail "
            ...
            String sqlUpdateDispenseDetails = ""
                    + " UPDATE pis_dispense_detail "
                    + " SET DISPENSED_QTY = '" + QTY_SUPPLIED + "' "
                    + " WHERE ORDER_NO = '" + ORDER_NO + "' AND DRUG_ITEM_CODE = '" + DRUG_ITEM_CODE + "' ";
        ...
        // Update Master Order
        String sqlUpdateOrderDetailsData = ""
                + " UPDATE pis_order_detail "
                + " SET QTY_SUPPLIED = '" + QTY_SUPPLIED + "',QTY_DISPENSED = '" + QTY_DISPENSED + "', "
        ...
        if (isUpdateOrderDetailsData == true) {
            ...
            if (totalOrder.size() == 0) {
                ...
                String sqlUpdateOrderMasterPartialData = ""
                        + " UPDATE pis_order_master "
                        + " SET TOTAL_ORDER = '" + totalOrderForOrderNo + "' "
                        + " WHERE ORDER_NO = '" + ORDER_NO + "' ";
        ...
        String sqlUpdateStockData = ""
                + " UPDATE pis_mdc2 "
                + " SET D_STOCK_QTY = '" + D_STOCK_QTY + "' "
                + " WHERE UD_MDC_CODE = '" + DRUG_ITEM_CODE + "' "
