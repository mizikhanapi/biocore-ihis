...
<div style="float: left;" id="patientOrderDispenseButtonDiv" > 
    <button class="btn btn-default " type="button" id="btnClearOrderDetailDispense" name="btnClearOrderDetailDispense" > <i class="fa fa-angle-left fa-lg"></i> &nbsp; Back &nbsp;</button>
</div>
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
    ...
    $('#patientOrderListContent').off('click', '#patientOrderListTable #moveToOrderDetailsTButton').on('click', '#patientOrderListTable #moveToOrderDetailsTButton', function (e) {
        ...
        $.ajax({
            url: "controllerProcessDispenseOrderSimple/patientOrderListDetailDispenseEHRCentralGetMSH.jsp",
            type: "post",
            timeout: 3000,
            data: data,
            success: function (returnDataMSHFull) {
                ...
                $.ajax({
                    url: "controllerProcessDispenseOrderSimple/patientOrderListDetailDispenseEHRCentralGetPDIFinal.jsp",
                    type: "post",
                    timeout: 3000,
                    data: data,
                    success: function (returnDataPDIFull) {
                        ...
                        $.ajax({
                            url: "controllerProcessDispenseOrderSimple/patientOrderListDetailDispenseEHRCentralGetORC.jsp",
                            type: "post",
                            data: data,
                            timeout: 3000,
    ...
    function loadAllergyDiagnosisOrder(orderNo, pmino) {
        ...
        $.ajax({
            url: "controllerProcessDispenseOrderSimple/patientOrderListAllergyTable.jsp",
            type: "post",
            data: dataAllergy,
            timeout: 3000,
            success: function (returnAllergyTableHTML) {
                ...
                $.ajax({
                    url: "controllerProcessDispenseOrderSimple/patientOrderListDiagnosisTable.jsp",
                    type: "post",
                    data: dataDiagnosis,
                    timeout: 3000,
                    success: function (returnDiagnosisTableHTML) {
                        ...
                        $.ajax({
                            url: "controllerProcessDispenseOrderSimple/patientOrderListDetailsNew.jsp",
                            type: "post",
                            data: dataOrder,
                            timeout: 3000,
...
//------------------------------------------------------------------------------  Add Part Start  -------------------------------------------------------------------------------------//
    ...
    $(function () {
        $("#orderDrugSearchInput").on('keyup', function () { // everytime keyup event
            ...
            if (input.length >= 1) { // Minimum characters = 2 (you can change)
                ...
                $.ajax({
                    type: "POST",
                    url: "controllerProcessDispenseOrderSimple/patientOrderListNewOrderSearch.jsp", // call the jsp file ajax/auto-autocomplete.php
    ...
    $('#orderDrugSearchInputDisplayResult').on('click', function () {
        ...
        $.ajax({
            type: 'post',
            url: 'controllerProcessDispenseOrderSimple/patientOrderListNewOrderSearchResult.jsp',
            data: {'id': id},
    ...
    $('#orderDrugAddButton').on('click', function (e) {
        ...
        if (drugTradeName === "" || drugTradeName === null) {
            ...
            $.ajax({
                url: "controllerProcessDispenseOrderSimple/patientOrderListNewOrderInsert.jsp",
                type: "post",
                data: datas,
                timeout: 10000,
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                ...
                if (result === true) {
                    ...
                    $.ajax({
                        url: "controllerProcessDispenseOrderSimple/patientOrderListNewOrderDelete.jsp",
                        type: "post",
                        data: data,
    ...
    function fullDispense() {
        ...
        table.find('tr').each(function (i) {
            ...
            if (drugChecked === true && drugDispensedQty !== "0") {
                ...
                $.ajax({
                    url: "controllerProcessDispenseOrderSimple/patientOrderListDetailsDispenceOverall.jsp",
                    type: "post",
                    data: dataAjax,
                    timeout: 3000,
                    success: function (datas) {
        ...
        $.ajax({
            url: "controllerProcessDispenseOrderSimple/patientOrderListDetailsDispenceEHRCentralInsertCallingDelete.jsp",
            type: "post",
                ...
                bootbox.confirm({
                    ...
                    callback: function (result) {
                        ...
                        if (result === true) {
                            ...
                            $.ajax({
                                url: "controllerProcessDispenseOrderSimple/patientOrderListDetailsPrescribeResetStatus.jsp",
                                type: "post",
                                data: data,
                                timeout: 5000,
                                success: function (datas) {
                                    ...
                                    $.ajax({
                                        url: "controllerProcessDispenseOrderSimple/patientOrderListDetailsPrescribeUpdateStatus.jsp",
                                        type: "post",
                                        data: data,
                                        timeout: 6000,
                                        success: function (datas) {
                                            ...
                                            $.ajax({
                                                type: "post",
                                                url: "controllerProcessDispenseOrderSimple/patientOrderListDetailsPrescribePDF.jsp",
                                                timeout: 5000,
                                                data: data,
            ...
            bootbox.confirm({
                ...
                callback: function (result) {
                    ...
                    if (result === true) {
                        ...
                        $.ajax({
                            url: "controllerProcessDispenseOrderSimple/patientOrderListDetailsDispenseCallPatientInsert.jsp",
                            type: "post",
                            data: data,
                            timeout: 3000,
                            success: function (result) {
            ...
            bootbox.confirm({
                ...
                callback: function (result) {
                    ...
                    if (result === true) {
                        ...
                        $.ajax({
                            url: "controllerProcessDispenseOrderSimple/patientOrderListDetailsDispenseCallPatientDelete.jsp",
                            type: "post",
                            data: data,
                            timeout: 3000,
                            success: function (result) {
