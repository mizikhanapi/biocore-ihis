                        ...
                        <div class="col-md-12">
                            <div class="thumbnail">
                                ...
                                <div class="text-center" style="margin-bottom: 20px;">
                                    <div class="btn btn-default file-preview-input"> <i class="fa fa-folder-open fa-lg"></i> <span class="file-preview-input-title">Browse</span>
                            ...
                            <div class="thumbnail">
                                ...
                                <div class="input-group file-preview">
                                    ...
                                    <span class="input-group-btn"> 
                                        ...
                                        <button type="button" class="btn btn-labeled btn-primary"> <span class="btn-label"><i class="fa fa-upload fa-lg"></i> </span>Import Drug MDC</button>
                                    </span> 
                                </div>
                                <br/>
                                <div class="panel panel-default">
