...
<table class="table table-hover" style="background: #ffffff; text-transform: uppercase; font-weight: 500; margin-top:-30px;">
    ...
    <tbody>
        ...
        %>
        <tr>
            <td style="text-align: left; font-weight: 400; width: 5%; font-size:24px;"><span id="qno_<%=i%>"><%=d.get(i).get(2)%></span></td>
            ...
            <td style="text-align: right;">
                ...
                <span style="    
                      ...
                      border-radius: 4px;
                      font-weight: 500;
                      color: #333; font-size: 21px;" id="qname_<%=i%>"><%=d.get(i).get(3)%></span>
                <script>
                    <% if (cs_callingtime > 0) {%>
