        ...
        %>
         ...
         <script>
            ...
            $('#contentRDaily').off('click', '#reportDailyTable #moveToDailySalesDetailsTButton').on('click', '#reportDailyTable #moveToDailySalesDetailsTButton', function (e) {
                ...
                $.ajax({
                    url: "manageReportDailyDetailTable_WARD.jsp",
                    type: "post",
                    data: data,
                    timeout: 3000,
                            ...
                            buttons: [
                                {
                                    ...
                                    title: ' Daily Ward Occupancy List For ' + rdate,
                                    ...
                                    customize: function (win) {
                                        ...
                                        <img src="<%=mysqlhfc_cd.get(0).get(0)%>" style="text-align: center; height: 100%; " /></div> <div class="mesej"><br>Daily Ward Occupancy List For ' + rdate + '</div>\n\
                                        ...
                                        $(win.document.body)
                                                ...
                                                .append('<div style="text-align: right;padding-top:10px;"><br>  Grand Total Ward Occupancy = ' + reportQuantity + ' </div>')
            ...
            $('#contentRMonthly').off('click', '#reportMonthlyTable #moveToMonthlySalesDetailsTButton').on('click', '#reportMonthlyTable #moveToMonthlySalesDetailsTButton', function (e) {
                ...
                $.ajax({
                    url: "manageReportMonthlyDetailsTable_WARD.jsp",
                    type: "post",
                    data: data,
                    timeout: 3000,
                    success: function (returnReportDetailsTableHTML) {
                            ...
                            buttons: [
                                {
                                    extend: 'excelHtml5',
                                    text: 'Export To Excel',
                                    title: 'Monthly Ward Occupancy List For ' + rdate,
                                    className: 'btn btn-primary',
                                    exportOptions: {
                                        columns: ':visible'
                                    }
                                    ...
                                    customize: function (win) {
                                        $(win.document.body)
                                                ...
                                                .prepend(
                                                        '<div class="logo-hfc asset-print-img" style="z-index: 0; top: 0px; opacity: 1.0;">\n\
                                        <img src="<%=mysqlhfc_cd.get(0).get(0)%>" style="text-align: center; height: 100%; " /></div> <div class="mesej"><br>Monthly Ward Occupancy List For ' + rdate + '</div>\n\
                                        <div class="info_kecik">\n\
                                        <dd>Date: <strong><%=newdate%></strong></dd>\n\
            ...
            $('#contentRYearly').off('click', '#reportYearlyTable #moveToYearlySalesDetailsTButton').on('click', '#reportYearlyTable #moveToYearlySalesDetailsTButton', function (e) {
                ...
                $.ajax({
                    url: "manageReportYearlyDetailsTable_WARD.jsp",
                    type: "post",
                    data: data,
                    timeout: 3000,
                    success: function (returnReportDetailsTableHTML) {
                            ...
                            buttons: [
                                {
                                    extend: 'excelHtml5',
                                    text: 'Export To Excel',
                                    title: 'Yearly Ward Occupancy List For ' + rdate,
                                    className: 'btn btn-primary',
                                    exportOptions: {
                                        columns: ':visible'
                                    }
                                    ...
                                    customize: function (win) {
                                        $(win.document.body)
                                                ...
                                                .prepend(
                                                        '<div class="logo-hfc asset-print-img" style="z-index: 0; top: 0px; opacity: 1.0;">\n\
                                        <img src="<%=mysqlhfc_cd.get(0).get(0)%>" style="text-align: center; height: 100%; " /></div> <div class="mesej"><br>Ward Occupancy List For ' + rdate + '</div>\n\
                                        <div class="info_kecik">\n\
                                        <dd>Date: <strong><%=newdate%></strong></dd>\n\
