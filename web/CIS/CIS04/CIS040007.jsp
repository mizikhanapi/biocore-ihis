        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <input class="form-control input-lg" type="text"  id="hfcOrderDetailADW" placeholder="">
                    <input class="form-control input-lg" type="text"  id="hfcProviderDetailADW" placeholder="">
