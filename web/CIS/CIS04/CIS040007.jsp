            ...
            <div class="modal-body">
                 ...
                 <div class="row">
                        <div class="form-group">
                            <input class="form-control input-lg " type="hidden" name="DateTo" id="tCIS_ADWsearchDisCd" placeholder="Code">
                             <input class="form-control input-lg " type="text" name="DateTo" id="tCIS_ADWsearchDis" placeholder="Search Discipline">
                             <div id="matchCIS_ADWsearchDis"></div>
                        </div>
                </div>
                <div class="row">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <input class="form-control input-lg " type="text" name="DateTo" id="tCIS_ADWreferFrom" placeholder="Search Discipline">
                        <div id="matchCIS_ADWreferFrom"></div>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group">
                ...
                <div class="row">
                    <div class="form-group">
                       <textarea type="text" name="display_name" id="tCIS_ADWreason" class="form-control input-lg" placeholder="Reason...." tabindex="3"></textarea>
                    </div>
                </div>
                <div class="row">
