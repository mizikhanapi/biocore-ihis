        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <input type="text" name="codeMON" id="codeMON" class="form-control input-lg"  tabindex="4">
                </div>

                <div class="form-group">
                    <div class="form-group">
                        <input class="form-control input-lg" type="text" name="searchMON"  id="searchMON" placeholder="Search Request Category" tabindex="4">
                        <div id="matchMON"></div>
                    </div>   
                </div>
                
<!--                <div class="form-group">
                    <input type="hidden" name="MONcode" id="MONcode" class="form-control input-lg" tabindex="4">
                </div>-->
...
<!--                <div class="form-group">
                    <input type="hidden" name="codeHFC_MON" id="codeHFC_MON" class="form-control input-lg" value="codeHFC_MON" tabindex="4">
                </div>-->
                  <input type="text" name="codeHFC_MON" id="MONHFC_cd" class="form-control input-lg" tabindex="4">
            <div class="form-group">
                    <div class="form-group">
                        <input class="form-control input-lg" type="text" name="searchDIS_MON"  id="searchDIS_MON" placeholder="Search Discipline"  tabindex="4">
...
<!--                <div class="form-group">
                    <input type="hidden" name="codeDIS_MON" id="codeDIS_MON" class="form-control input-lg" value="codeDIS_MON" tabindex="4">
                </div>-->
