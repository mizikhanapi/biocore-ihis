                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input class="form-control input-lg" type="text" name="tCIS_P_DCGDate" id="tCIS_DCGDate_P" placeholder="DD/MM/YYYY" readonly="">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input class="form-control input-lg" type="text" name="tCIS_P_DCGTime" id="tCIS_DCGTime_P" placeholder="" readonly="">
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer" id="actionGSC">
                <div class="btn-group btn-group-justified" role="group" aria-label="group button">
                    <div class="btn-group" role="group">
                        <a class="btn btn-primary btn-block btn-lg gcsAccept " id="btnCIS_Discharge_Summary" >Submit</a>
                    </div>
