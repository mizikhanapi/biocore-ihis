...
<%
    Conn Conn = new Conn();
                               ...
                               String searchProblem = "SELECT om.order_no,om.hfc_to,hf.hfc_name,od.modality_cd,m.modality_name,od.body_system_cd,bs.body_system_name,od.procedure_cd,pm.ris_procedure_name "
