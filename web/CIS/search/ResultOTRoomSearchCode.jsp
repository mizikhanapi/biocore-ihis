...
<%
    ...
    String searchProblem = "select room_no,room_name from ot_room WHERE hfc_cd = '"+hfc_cd+"' AND dis_cd = '"+discipline+"' AND `subDis_cd` = '"+subdicipline+"' and room_name='"+room_name+"';;";
