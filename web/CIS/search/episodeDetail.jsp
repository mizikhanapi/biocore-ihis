...
<h4 style="padding: 10px 0px 15px;">
    ...
    <a class="btn btn-default pull-right" href="#searchPatient1" id="ViewDetail" name="ViewDetail"  type="button" role="button"><i class="fa fa-arrow-up fa-lg" aria-hidden="true" style="display: inline-block;color: #337ab7;"></i></a>
</h4>
