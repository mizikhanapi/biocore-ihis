...
<form class="form-horizontal" name="myForm" id="myFormMC">
    <!-- Select Basic -->
    ...
    <div class="text-center">
        <button class="btn btn-primary" type="button" id="searchPatientTC" name="searchPatient"><i class="fa fa-search fa-lg"></i>&nbsp; Search</button>

        <button id="clearSearchTC" name="clearSearch" type="clear" class="btn btn-default"><i class="fa fa-ban fa-lg"></i>&nbsp; Clear</button>
    </div>
</form>

<div id="tsTableDivision"></div>
...
<script>
    ...
    $('#searchPatientTC').on('click', function () {
        searchPatientTC();
    });


    //seaching patient function   
    function searchPatientTC() {
