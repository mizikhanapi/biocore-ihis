...
<%
    ...
    //                              0           1               2               3               4                   5                6   
    String allergyList = "SELECT alg.pmi_no, alg.hfc_cd, alg.episode_date, alg.allergy_cd, alg.icd10_description, alg.comment, adm.hfc_name, DATE_FORMAT(alg.episode_date, '%d/%m/%Y %T') "
...
<table class="table table-filter table-striped table-bordered dt-head-right" style="background: #fff; border: 1px solid #ccc; width: 100%; text-align: left" id="patientAllergyListTable">
    ...
    <th style="text-align: left;display: none;">ALLERGY CODE</th>
    <th style="text-align: left;">ALLERGY NAME</th>
...
<tbody>
    ...
    <tr style="text-align: left;">
        ...
        <td ><%= dataAllergyList.get(i).get(7)%></td> <!-- EPISODE DATE -->
        <td  style="display: none"><%= dataAllergyList.get(i).get(3)%></td> <!-- ALERYGY CODE -->
