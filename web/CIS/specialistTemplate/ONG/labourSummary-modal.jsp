    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="lineModalLabel">Labour</h3>
            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <select id="LS_labourOnset" class="form-control input-md">
                                        ...
                                        <option value="">Induced</option>
                                        <option value="">Augmented</option>
                                        <option value="">Oxytocin</option>
                                        <option value="">Prostagiandins</option>
                                        <option value="">SROM</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <select id="LS_labourVaginal" class="form-control input-md">
                                        ...
                                        <option value="">SVD</option>
                                        <option value="">Vacuum delivery</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <select id="LS_labourTear" class="form-control input-md">
                                        ...
                                        <option value="">Episiotomy</option>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="btn-group btn-group-justified" role="group" aria-label="group button">
                    ...
                    <div class="btn-group" role="group" id="LS_labour_infant_update" style="display: none">
