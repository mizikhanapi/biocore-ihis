    ...
    <div class="col-md-12">
        ...
        <div id="ModalKin"><%@include file = "KinModal.jsp" %></div>
            <h4>List of Next of Kin
                <button id="addKINmodal" name="addKINmodal" class="btn btn-primary pull-right" data-toggle="modal" data-target="#KINModal"><i class="fa fa-plus"></i>&nbsp; Add Next Of Kin Information</button>
            </h4>
            <br/>
