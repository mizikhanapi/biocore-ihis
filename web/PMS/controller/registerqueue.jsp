...
//out.print(queue_now);
        ...
        insertPatientQueue = "insert into pms_patient_queue(hfc_cd,queue_name,episode_date,user_id,pmi_no,queue_no,queue_type,status,patient_category,created_by,created_date)values('" + hfc + "','" + queue_name1 + "','" + epiDate + "','" + docID + "','" + pmi + "','" + newQueueNo + "','" + comTy + "','0','1','"+createdBy+"',NOW());";
