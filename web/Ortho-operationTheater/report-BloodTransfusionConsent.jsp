                ...
                <div id="bloodTransfusionForm">
                    ...
                    <div style="height:140px;">
                        <div class="" style="width: 34%; float: right;">
                            <P  style="white-space:pre">Date        :   <strong id="BTCF-currDate"><%//=currDate%></strong></p>
                            <p  style="white-space:pre">Age         :   <strong id="BTCF-age"><%//=patientBioList1[6]%></strong></p>
                            <p  style="white-space:pre">Sex         :   <strong id="BTCF-sex"><%//=patientBioList1[4]%></strong></p>
                        </div>
                        <div class="" style="width: 60%; float: left; margin-top: 30px;">
                            <P  style="white-space:pre">Patient's Name        :   <strong id="BTCF-patientName"><%//=patientBioList1[1]%></strong></p>
                            <p  style="white-space:pre">Identity Card No      :   <strong id="BTCF-IC"><%//=patientBioList1[2]%></strong></p>
                            <p  style="white-space:pre">Address                   :   <strong id="BTCF-address"><%//=address%></strong></p>
                        </div>  
                    </div>
                    <div class="" >
