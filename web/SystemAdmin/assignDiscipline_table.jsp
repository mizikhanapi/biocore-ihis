...
<td style="width: 5% ">
    ...
    <!-- Update Part Start -->
    <a id="ADT_btnUpdate" data-toggle="modal" data-target="#ADT_detail" style="cursor: pointer"><i data-toggle="tooltip" data-placement="left" title="Update assignment" class="fa fa-pencil-square-o fa-lg" aria-hidden="true" style="display: inline-block;color: #337ab7;"></i></a>
    <!-- Delete Button Start -->
    &nbsp;&nbsp;&nbsp;
    <a id="ADT_btnDelete" class="testing" style="cursor: pointer"><i data-toggle="tooltip" data-placement="right" title="Delete assignment" class="fa fa-times fa-lg" aria-hidden="true" style="display: inline-block;color: #d9534f;" ></i></a>
    <!-- Delete Button End -->
</td>
</tr>
            ...
            <div class="modal-footer">
                <div class="btn-group btn-group-justified" role="group" aria-label="group button">
                    <div class="btn-group" role="group">
                        <button type="submit" class="btn btn-primary btn-block btn-lg" role="button" id="ADT_btnUpdateConfirm">Update</button>
                    </div>
                    <div class="btn-group" role="group">
