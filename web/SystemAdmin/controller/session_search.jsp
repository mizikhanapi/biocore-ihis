...
+ "WHERE  concat(d.discipline_cd, ' | ', d.discipline_name) like '%"+input+"%' ";
        ArrayList<ArrayList<String>> search = conn.getData(sql);
...
+ "WHERE s.discipline_cd = '"+disciplineCode+"' AND (concat(s.subdiscipline_cd, ' | ', s.subdiscipline_name) like '%"+input+"%')";
        ArrayList<ArrayList<String>> search = conn.getData(sql);
