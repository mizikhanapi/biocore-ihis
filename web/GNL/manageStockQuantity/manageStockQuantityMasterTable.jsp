...
<tbody>
    ...
    <%
        ...
        //                      0               1           2                                             3           4               5               6           7           8
        String sql = "SELECT vh.vendor_id,vh.invoice_no,DATE_FORMAT(vh.txt_date, '%d/%m/%Y'),vh.hfc_cd,vh.discipline,vh.sub_discipline,vh.location,vh.total_amt,vh.quantity,"
                //       9            10               11           12          13              14
                ...
                + " AND v.hfc_cd = '" + hfc + "' AND vh.subledger_type IN (" + moduleCode + ") ORDER BY vh.txt_date DESC";
    ...
    %>
    <tr id="moveToInvoiceDetailsTButton" style="text-align: left;cursor: pointer;" class="clickable_tr">
