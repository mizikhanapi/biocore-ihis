                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1"> Gender: 
                                                <%=dataPatientApp.get(i).get(17) //                                                    String getGender = "SELECT ald.`Description` FROM adm_lookup_master alm,adm_lookup_detail ald WHERE alm.`Master_Reference_code`=ald.`Master_Reference_code` AND alm.`Description` = 'Gender' AND ald.`Detail_Reference_code` = '"+dataPatientApp.get(i).get(6)+"'";
