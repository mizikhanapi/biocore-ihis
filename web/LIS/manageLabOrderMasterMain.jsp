        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
                <div class="input-group">
                    <select class="form-control"  id="LAB_OrderTime" style="margin-bottom: 0px !important;">
                    ...
                    <span class="input-group-btn">
                        <button class="btn btn-default" id="LAB_OrderSearch"><i class=" fa fa-search" style=" padding-right: 5px;padding-left: 5px;color: black;"></i></button>
                    </span>
                </div>
            </div>
...
<script>
    ...
    $(function () {
        ...
        $('#LAB_OrderTime').on('change', function () {
        ...
        $('#LAB_OrderSearch').on('click', function () {
