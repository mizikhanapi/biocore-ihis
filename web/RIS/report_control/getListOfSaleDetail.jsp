...
<%
    ...
    String query="SELECT od.procedure_cd, pm.ris_procedure_name, count(od.order_no), sum(pm.selling_price) "
            ...
            + "WHERE om.hfc_cd='"+hfc_cd+"' AND om.billing_status='2' AND date_format(om.order_date, '"+timeFrame+"')='"+date+"' "
