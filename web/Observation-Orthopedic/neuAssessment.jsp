...
<form class="form-horizontal" name="myForm2" id="myForm2">
        ...
        <div class="col-md-12">
            <div class="checkbox-inline">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <input id="rnNo" name="rnNo" type="date" placeholder="Specify..." class="form-control input-md" style="margin-top: 8px!important;">
                    </div>
                </div>
            </div>
            <div class="checkbox-inline">
    ...
    <div class="text-center margin-top-50px">
        <button class="btn btn-default" type="button" data-toggle="modal" data-target="#appointmentModal" id="appointment"> Save</button>
        <button class="btn btn-default" type="button" data-toggle="modal" data-target="#queueModal" id="queue">Clear</button>
    </div>
</form>