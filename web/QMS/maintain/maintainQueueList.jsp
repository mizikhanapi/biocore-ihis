...
<h4 style="padding-top: 30px;padding-bottom: 35px; font-weight: bold">Maintain Queue List
    <span class="pull-right">
        <button id="Lplus" class="btn btn-primary" data-status="pagado" data-toggle="modal" data-id="1" data-target="#list" style=" padding-right: 10px;padding-left: 10px;color: white;"><a data-toggle="tooltip" data-placement="top" title="Add Queue List" ><i class=" fa fa-plus" style=" padding-right: 10px;padding-left: 10px;color: white;"></i></a>Add Queue List</button>
    </span>
</h4>
