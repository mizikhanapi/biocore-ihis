...
<%
    ...
    String sqlDisplayHoliday = "SELECT 'lala', ld.`Master_Reference_code`, ld.Detail_Reference_code, pmsh.state_code, pmsh.holiday_date, pmsh.holiday_desc, pmsh.holiday_type, pmsh.status, pmsh.status, pmsh.created_by, pmsh.created_date, ld.Description "
            + "FROM pms_holiday pmsh "
            + "LEFT JOIN adm_lookup_detail ld ON  ld.`Master_Reference_code` = '0002' AND ld.`Detail_Reference_code` = pmsh.state_code AND ld.hfc_cd = pmsh.hfc_cd "
            + "WHERE pmsh.hfc_cd = '" + hfc + "' "
...
<div class="table-responsive" id="viewAllHoliday">
    <table class="table table-bordered table-hover" id="viewHoliday">
        ...
        <%
                        ...
                        out.print("<td colspan='2'>" + e.toString() + "</td>");
                    }
