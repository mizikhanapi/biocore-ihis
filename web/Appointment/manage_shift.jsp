        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" id="Manage_SHIFT_ADD_FORM">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <select class="form-control input-md" id="Add_shift_duration">
            ...
            <div class="modal-footer" id="ActionAddShift">
                <div class="btn-group btn-group-justified" role="group" aria-label="group button">
                    ...
                    <div class="btn-group" role="group">
                        <button type="reset" id="btnReset" class="btn btn-default btn-block btn-lg" data-dismiss="modal" role="button" onclick="clearShiftForm()" >Cancel</button>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#modal_manage_shift").on('hide.bs.modal', function () {
            $('#ActionUpdateShift').hide();
            $('#ActionAddShift').show();
            $('#Add_shift_code').prop('disabled', false);
...
//                console.log(time.format("HH:mm"));
        ...
        $("#btnAddShiftName").click(function (e) {
            ...
            if (shift_code === "") {
                ...
                alert("Please enter the shift time");
            } else if (shift_duration === "" || shift_duration == null) {
                alert("Please enter the shift duration");
            } else if (end_time === "") {
                alert("Please enter the shift end time");
            } else if (start_date === "") {
