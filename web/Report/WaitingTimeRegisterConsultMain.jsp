<%-- 
    Document   : WaitingTimeRegisterConsultMain
    Created on : Oct 26, 2018, 12:03:03 AM
    Author     : Shammugam
--%>
...
<div style="width:50%;margin: auto;text-align: center;padding-top: 20px;padding-bottom: 20px;" id="waitingTimeReportSearchDiv">
    ...
    <h4> <b>Please Choose the The Prefered Filter. Insert the Required Details Then Press The "Generate Report" Button</b> </h4>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#reportWaitingTimeMainDIV').off('click', '#waitingTimeReportSearchDiv #waitingTimeReportBtn').on('click', '#waitingTimeReportSearchDiv #waitingTimeReportBtn', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "WaitingTimeRegisterConsultTable.jsp",
                data: data,
                timeout: 1000000000,
