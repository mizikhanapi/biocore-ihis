<%-- 
    Document   : WaitingTimeConsultRadiology
    Created on : Oct 27, 2018, 12:10:07 AM
    Author     : Shammugam
--%>
...
<html>
    ...
    <body>
                ...
                <div class="row">      
                    <div class="col-md-12">
                        ...
                        <div class="thumbnail">
                            ...
                            <h3 style="margin: 0px;"> Waiting Time Report (Consultation -> Radiology) </h3>
                            <hr class="pemisah" />
        ...
        <script>
            ...
            $('#R12R6').addClass('active');
            
            $("#reportWaitingTimeMainDIV").load("WaitingTimeConsultRadiologyMain.jsp");
