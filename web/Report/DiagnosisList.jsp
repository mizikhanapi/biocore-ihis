<%-- 
    Document   : DiagnosisList
    Created on : Sep 26, 2018, 3:41:55 AM
    Author     : shay
--%>
...
<html>
    <head>
        ...
        <title>Diagnosis List Report</title>
        ...
        <div class="main" style="background: #f2ff4f8;"> 
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="thumbnail">
                        <form>
                            <h4 style="margin: 0px; padding: 0;">Diagnosis List</h4>
                            <hr class="pemisah"/>
                            ...
                            <div class="text-center">
                                <button class="btn btn-primary" type="button" id="searchDiagnosisList" name="searchDiagnosisList"><i class="fa fa-search fa-lg" ></i>&nbsp; Search</button>
                    ...
                    <div class="thumbnail">
                        <div id="UTeMDiagnosisListReportTable">

                            <table  id="UTemDReport"  class="table table-striped table-bordered" cellspacing="0" width="100%">
                                <thead >
                                <th style="text-align: center;">no.</th>
                                <th style="text-align: center;">ICD10 Code</th>
...
//                ddMMyyyy = ZeroDay + "/" + ZeroMonth + "/" + year;
            ...
            $("#searchDiagnosisList").click(function () {
                                    ...
                                    buttons: [
                                        {
                                            ...
                                            title: 'Diagnosis List, From ' + startDateori + ' To ' + endDateori,
                                        ...
                                        <img src="<%=mysqlhfc_cd.get(0).get(0)%>" style="text-align: center; height: 100%; " /></div> <div class="mesej"><br>Diagnosis List</div>\n\
