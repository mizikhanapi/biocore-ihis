<%-- 
    Document   : WaitingTimeRegisterConsult
    Created on : Oct 26, 2018, 12:01:06 AM
    Author     : Shammugam
--%>
...
<html>
    ...
    <body>
                ...
                <div class="row">      
                    <div class="col-md-12">
                        ...
                        <div class="thumbnail">
                            ...
                            <h3 style="margin: 0px;"> Waiting Time Report (Registration -> Consultation) </h3>
                            <hr class="pemisah" />
        ...
        <script>
            ...
            $('#R12R2').addClass('active');
            
            $("#reportWaitingTimeMainDIV").load("WaitingTimeRegisterConsultMain.jsp");
