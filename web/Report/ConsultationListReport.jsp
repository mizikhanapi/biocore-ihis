<%-- 
    Document   : ConsultationListReport
    Created on : Sep 26, 2018, 1:54:09 AM
    Author     : shay
--%>
        ...
        <div class="main" style="background: #f2ff4f8;"> 
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="thumbnail">
                        <form>
                            <h4 style="margin: 0px; padding: 0;">Consultation List</h4>
                            <hr class="pemisah"/>
                            ...
                            <div class="text-center">
                                <button class="btn btn-primary" type="button" id="searchConsultationList" name="searchConsultationList"><i class="fa fa-search fa-lg" ></i>&nbsp; Search</button>
                    ...
                    <div class="thumbnail">
                        <div id="UTeMConsultationListReportTable">
