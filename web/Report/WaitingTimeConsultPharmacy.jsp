<%-- 
    Document   : WaitingTimeConsultPharmacy
    Created on : Oct 26, 2018, 12:57:17 AM
    Author     : Shammugam
--%>
...
<html>
    ...
    <body>
                ...
                <div class="row">      
                    <div class="col-md-12">
                        ...
                        <div class="thumbnail">
                            ...
                            <h3 style="margin: 0px;"> Waiting Time Report (Consultation -> Pharmacy) </h3>
                            <hr class="pemisah" />
        ...
        <script>
            ...
            $('#R12R3').addClass('active');
            $("#reportWaitingTimeMainDIV").load("WaitingTimeConsultPharmacyMain.jsp");
