...
public class ADW_seq {
    
    private String ADWNo = "";
    private String zero = "";
    private String num = "";
    ...
    public void setADW_seq(){
    
      String sql2 = "SELECT module_name,seq_no FROM orders_no where module_name = 'ADW'"; 
        ...
        for (int j = 0; j < data2.size(); j++) { 
            ...
            ADWNo = seqId + dateForID + num;

            //UPDATE SEQUENCE NUMBER
            String updateRISNoSequence = "UPDATE orders_no SET seq_no = '" + currentSeq + "' WHERE module_name = 'ADW' ";

            boolean isUpdateRISNoSequence = rc.setQuerySQL(Config.ipAddressServer, Config.portServer, updateRISNoSequence);
        }
        System.out.println(ADWNo);    
    }
    
    public String getADW_orderno() {
        return ADWNo;
    }
