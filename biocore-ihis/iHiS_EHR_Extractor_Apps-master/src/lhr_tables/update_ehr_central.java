...
public class update_ehr_central {
    ...
    public void update_status() {
        ...
        String sql_update_ehr_central = "UPDATE `ehr_central` SET `STATUS` = '3' WHERE `ehr_central`.`central_code` = '" + t.getCentral_Code() + "'"; // Update patient status to 3 by using CENTRAL_CODE unique column data.
