    ...
    * get data from DB
    ...
    public ArrayList<ArrayList<String>> get4hly(String datas) {
        ...
        if (viewBy.equalsIgnoreCase("today")) {
            ...
            sql = "SELECT pmi_no,hfc_cd,episode_date,encounter_date,DATE_FORMAT(DATE(thrombophlebitis_date),'%d/%m/%Y'),TIME_FORMAT(TIME(thrombophlebitis_date),'%r'),site_iv_canulation,pain_score,slight_redness,redness,swelling,palpable_venous_cord,unconscious_pl,thrombophlebitis,vlp_score,medication,blood_tx,plain_iv_drip,assign_by,TIME_FORMAT(TIME(thrombophlebitis_date),'%T'),discipline_cd,subdicipline_cd FROM lhr_ort_niw_chart_observation_thrombophlebitis where pmi_no ='" + pmino + "' and DATE(thrombophlebitis_date) ='" + dateTime + "';";

        } else if (viewBy.equalsIgnoreCase("yesterday")) {
            sql = "SELECT pmi_no,hfc_cd,episode_date,encounter_date,DATE_FORMAT(DATE(thrombophlebitis_date),'%d/%m/%Y'),TIME_FORMAT(TIME(thrombophlebitis_date),'%r'),site_iv_canulation,pain_score,slight_redness,redness,swelling,palpable_venous_cord,unconscious_pl,thrombophlebitis,vlp_score,medication,blood_tx,plain_iv_drip,assign_by,TIME_FORMAT(TIME(thrombophlebitis_date),'%T'),discipline_cd,subdicipline_cd FROM lhr_ort_niw_chart_observation_thrombophlebitis where pmi_no ='" + pmino + "' and  DATE(thrombophlebitis_date) = SUBDATE('" + dateTime + "',1);";

        } else if (viewBy.equalsIgnoreCase("7day")) {
            sql = "SELECT pmi_no,hfc_cd,episode_date,encounter_date,DATE_FORMAT(DATE(thrombophlebitis_date),'%d/%m/%Y'),TIME_FORMAT(TIME(thrombophlebitis_date),'%r'),site_iv_canulation,pain_score,slight_redness,redness,swelling,palpable_venous_cord,unconscious_pl,thrombophlebitis,vlp_score,medication,blood_tx,plain_iv_drip,assign_by,TIME_FORMAT(TIME(thrombophlebitis_date),'%T'),discipline_cd,subdicipline_cd FROM lhr_ort_niw_chart_observation_thrombophlebitis where pmi_no ='" + pmino + "' and DATE(thrombophlebitis_date) between SUBDATE('" + dateTime + "',7) and '" + dateTime + "'  ;";

        } else if (viewBy.equalsIgnoreCase("30day")) {
            sql = "SELECT pmi_no,hfc_cd,episode_date,encounter_date,DATE_FORMAT(DATE(thrombophlebitis_date),'%d/%m/%Y'),TIME_FORMAT(TIME(thrombophlebitis_date),'%r'),site_iv_canulation,pain_score,slight_redness,redness,swelling,palpable_venous_cord,unconscious_pl,thrombophlebitis,vlp_score,medication,blood_tx,plain_iv_drip,assign_by,TIME_FORMAT(TIME(thrombophlebitis_date),'%T'),discipline_cd,subdicipline_cd FROM lhr_ort_niw_chart_observation_thrombophlebitis where pmi_no ='" + pmino + "' and DATE(thrombophlebitis_date) between SUBDATE('" + dateTime + "',30) and '" + dateTime + "' ;";

        } else if (viewBy.equalsIgnoreCase("60day")) {
            sql = "SELECT pmi_no,hfc_cd,episode_date,encounter_date,DATE_FORMAT(DATE(thrombophlebitis_date),'%d/%m/%Y'),TIME_FORMAT(TIME(thrombophlebitis_date),'%r'),site_iv_canulation,pain_score,slight_redness,redness,swelling,palpable_venous_cord,unconscious_pl,thrombophlebitis,vlp_score,medication,blood_tx,plain_iv_drip,assign_by,TIME_FORMAT(TIME(thrombophlebitis_date),'%T'),discipline_cd,subdicipline_cd FROM lhr_ort_niw_chart_observation_thrombophlebitis where pmi_no ='" + pmino + "' and DATE(thrombophlebitis_date) between SUBDATE('" + dateTime + "',60) and '" + dateTime + "' ;";

        } else if (viewBy.equalsIgnoreCase("custom")) {
            String dateSplit[] = dateTime.split("\\^", -1);
            startDate = dateSplit[0];
            endDate = dateSplit[1];
            sql = "SELECT pmi_no,hfc_cd,episode_date,encounter_date,DATE_FORMAT(DATE(thrombophlebitis_date),'%d/%m/%Y'),TIME_FORMAT(TIME(thrombophlebitis_date),'%r'),site_iv_canulation,pain_score,slight_redness,redness,swelling,palpable_venous_cord,unconscious_pl,thrombophlebitis,vlp_score,medication,blood_tx,plain_iv_drip,assign_by,TIME_FORMAT(TIME(thrombophlebitis_date),'%T'),discipline_cd,subdicipline_cd FROM lhr_ort_niw_chart_observation_thrombophlebitis where pmi_no ='" + pmino + "' and DATE(thrombophlebitis_date) between '" + startDate + "' and '" + endDate + "';";
        }
